...
{C.RED}{C.BOLD}
 ...
 /_/ ___\\____/\\__,_/  /_/ /_/\\__,_/ |__/|__/_/|_|  
   ...
   / / / /\\__ \\/ //  |/ / / /                       
  / /_/ /___/ / // /|  / / /                        
  \\____//____/___/_/ |_/ /_/  v3.0                  
{C.RESET}"""
]

print(f"{C.BOLD}{C.BRIGHT_MAGENTA}Developer ❖─♡️⏤͟͟͞͞★ᏰᎧᏕᏕꗄ♡️─❖ {C.BRIGHT_GREEN}░M░a░x░o░d░{C.RESET}")
...
def show_banner():
    ...
    print(f"    {C.GREEN}  20+ Modules | Threaded | Auto-Report{C.RESET}")
